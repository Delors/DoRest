...
object HStatus extends Enumeration {
    ...
    def fromInt(code: Int): HStatus.Value = code match {
        case 100 => Continue
        case 101 => SwitchingProtocol
        /* 200 */
        case 200 => OK
        case 201 => Created
        case 202 => Accepted
        case 203 => NotAuthoritativeInformation
        case 204 => NoContent
        ...
        case 407 => ProxyAuthentificationRequired
        ...
        case 416 => RequestRangeNotSatisfiable
